...
<header class="bg-dark py-5">
    <div class="container px-4 px-lg-5 my-5">
        <div class="text-center text-white">
            ...
            <p class="lead fw-normal text-white-50 mb-0">Fuel your muscles</p>
        </div>
    </div>
</header>
...
<section class="py-4">
    ...
    <div id="catproddiv" class="prodListDiv">
        ...
        <div id="header">
            <h3 class=" pe-1">All products - {{count($productVariations)}} products</h3>
            <div class="ps-1">
                ...
                <ul class="dropdown-menu" aria-labelledby="categoriesDropdown">
                    <li><a class="dropdown-item" href="{{url('/products/category/'.$category->id.'?sort=nameasc')}}">Name &#8593;</a></li>
                    <li><a class="dropdown-item" href="{{url('/products/category/'.$category->id.'?sort=namedesc')}}">Name &#8595;</a></li>
                    <li><a class="dropdown-item" href="{{url('/products/category/'.$category->id.'?sort=priceasc')}}">Price &#8593;</a></li>
                    <li><a class="dropdown-item" href="{{url('/products/category/'.$category->id.'?sort=pricedesc')}}">Price &#8595;</a></li>
                    <li><a class="dropdown-item" href="{{url('/products/category/'.$category->id.'?sort=rating')}}">Rating</a></li>
                </ul>
            </div>
            <div class="ps-1">
                <a class="nav-link dropdown-toggle" id="categoriesDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">{{$category->name}}</a>
                <ul class="dropdown-menu" aria-labelledby="categoriesDropdown">
        ...
        <div id="diffall" class="divfordropdown">
            <button class="dropbtn">Shop by Sub-Category</button>
            <!-- .asideProdList -->
            @include ('partials.aside', ['category' => $category])
        </div>
